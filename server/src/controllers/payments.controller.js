...
class PaymentsController {
    ...
    async checkPaymentMomo(req, res, next) {
        ...
        if (resultCode === '0') {
            ...
            return res.redirect(`http://localhost:5173/payment/${singlePaymentId}`);
        }
    }
        ...
        try {
            ...
            await Promise.all(
                orders.map(async (order) => {
                    ...
                    groupedOrders[orderData.idPayment].totalPrice = groupedOrders[orderData.idPayment].products.reduce(
